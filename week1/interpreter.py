...
def main():
    ...
    x = int(exp.strip().lower().split()[0])
    y = exp.strip().lower().split()[1]
    z = int(exp.strip().lower().split()[-1])
...
def math(x,y,z):
    match y:
        case "+":
            addition = x + z
            print(f"{float(addition):.1f}")  
        case "-":
            substraction = x - z
            print(f"{float(substraction):.1f}")
        case "*":
            multiplication = x * z
            print(f"{float(multiplication):.1f}")
        case "/":
            division = x / z
            print(f"{float(division):.1f}")
        case _:
